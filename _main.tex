...
\urlstyle{same}
\hypersetup{
  pdftitle={Flujogramas de Datos FACSO},
  pdfauthor={Facultad de Ciencias Sociales},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Flujogramas de Datos FACSO}
